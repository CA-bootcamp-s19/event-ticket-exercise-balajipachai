...
contract EventTickets {
    ...
    */
    ...
    event LogEndSale(address contractOwner, uint amountTransferred);
    ...
    */
    function buyTickets(uint _numberOfTickets) public payable {
        ...
        require(msg.value >= (TICKET_PRICE * _numberOfTickets));
        ...
        msg.sender.transfer(msg.value - (TICKET_PRICE * _numberOfTickets));
